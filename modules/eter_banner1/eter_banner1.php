...
class Eter_Banner1 extends Module implements WidgetInterface
{
    /**
    ...
    */
    public function __construct()
    {
        ...
        parent::__construct();
        $this->bootstrap = true;
        $this->displayName = $this->l('Image Banner 1');
    ...
    /**
    * Install module, in this function add and register hooks, and add new tab "Home Banner 1" in back office
    */
    public function install()
    {
        Configuration::updateValue('BANNER1_IMAGE_NAME', "default/banner1.jpg");
        Configuration::updateValue('BANNER1_IMAGE_NAME_MOBILE', "default/banner1_mobile.jpg");
        $languages = Language::getLanguages(false);
        foreach ($languages as $lang) {
            Configuration::updateValue('BANNER1_URL_L'.$lang['id_lang'], "#");
        }
        /* Adds Module */
        ...
        && EterHelper::addModuleTabMenu('AdminHomeContent','AdminEterBanner1','Banner 1',$this->name,20);
    }
    /**
    * Uninstall module, remove tab "Home Banner 1" from back office
    */
    public function uninstall()
    {
        Configuration::deleteByName('BANNER1_IMAGE_NAME');
        Configuration::deleteByName('BANNER1_IMAGE_NAME_MOBILE');
        $languages = Language::getLanguages(false);
        foreach ($languages as $lang) {
            Configuration::deleteByName('BANNER1_URL_L'.$lang['id_lang']);
        }
        return parent::uninstall()
            && EterHelper::removeModuleTabMenu('AdminEterBanner1')
    ...
    */
    public function renderWidget($hookName = null, array $configuration = [])
    {
        ...
        return $this->display(__FILE__, 'views/templates/front/banner1.tpl');        
    }
    /**
    ...
    */
    public function getWidgetVariables($hookName = null, array $configuration = [])
    {
        ...
        $image = Configuration::get('BANNER1_IMAGE_NAME');
        $image_mobile = Configuration::get('BANNER1_IMAGE_NAME_MOBILE');
        ...
        $data['url'] = Configuration::get('BANNER1_URL_L'.$lang);
        $data['image'] = $src;
