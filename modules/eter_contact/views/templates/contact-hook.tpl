	...
	<div id="eter-contact">
		<div class="contact-options">
			{if isset($facebook)}
				<a href="{$facebook}" target="_blank">
					...
					{l s='Facebook chat' mod='eter_contact'}
				</a>
			{/if}
			{if isset($whatsapp)}
				<a href="{$whatsapp}" target="_blank">
					...
					{l s='Whatsapp chat' mod='eter_contact'}
				</a>
			{/if}
			{if isset($contact)}
				<a href="#" target="_blank" class="etercontact">
					<i class="material-icons">email</i>
					{l s='Contact form' mod='eter_contact'}
				</a>
				<script type="text/javascript">
					var contactdata = {$contact nofilter};
				</script>
			{/if}
			{if isset($phone)}
				<a href="tel:{$phone}" target="_blank">
					<i class="material-icons">phone</i>
					{l s='Call Us' mod='eter_contact'}
				</a>
			{/if}
		</div>
		<div class="contact-circle">
			<div class="circle">
				...
				<div class="contact-text">{l s='Contact' mod='eter_contact'}</div>
			</div>
		</div>
	</div>
{/if}