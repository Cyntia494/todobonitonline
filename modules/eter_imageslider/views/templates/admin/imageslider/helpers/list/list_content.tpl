				...
				{if isset($tr.$key)}
					...
					{elseif isset($params.position)}
						...
						{else}
							{$tr.$key.position + 1}
						{/if}
					{elseif isset($params.image_back)}
						<img src="{$tr.image_back}" height="60"  title="admin" />
					{elseif isset($params.image_main)}
						<img src="{$tr.image_main}" height="60"  title="admin" style="margin-bottom: 10px;margin-top: 10px;" />
