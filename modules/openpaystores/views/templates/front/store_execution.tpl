        ...
        <div class="openpay-form-container">
            ...
            <div class="row mb30">
                ...
                <div class="col-md-4 center">
                    ...
                    <p>{l s='Click on the "Generate payment receipt" and your purchase will be waiting for your payment.' mod='openpaystores'}</p>
                </div>
                <div class="col-md-4 center">
                    <div><img src="{$module_dir|escape:'htmlall':'UTF-8'}views/img/step_store.png"></div>
                    <p>{l s='Print your receipt, take it to your nearest convenience store and make payment.' mod='openpaystores'}</p>
                </div>
                <div class="col-md-4 center">
                    <div><img src="{$module_dir|escape:'htmlall':'UTF-8'}views/img/step3.png"></div>
                    <p>{l s='Immediately after receiving your payment we will send you an email with your payment confirmation.' mod='openpaystores'}</p>
                </div>
            </div>
