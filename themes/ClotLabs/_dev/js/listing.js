...
$(document).ready(() => {
  prestashop.on('clickQuickView', function (elm) {
    ...
    $.post(prestashop.urls.pages.product, data, null, 'json').then(function (resp) {
      ...
      $('.quickview .product-gallery').eagleGallery({
  ...
  $('body').on('click', '.js-search-mobile-filters-clear-all', function (event) {
    event.preventDefault();
  ...
  $('body').on('click','.search_filter_toggler',function(){
    $('#search_filters_wrapper').toggleClass('showFilter');
    $('.sort-input,body').removeClass('showSort');
...
function updateProductListDOM (data) {
  ...
  $('#eter_search_filters').replaceWith(data.rendered_facets);
...
function addFilterEvents() {
  $('.facet .title').click(function(e){
      e.preventDefault();
      var parent = $(this).closest('.facet');
      parent.toggleClass('showfacet');
  });

  $('.sort-input,body').removeClass('showSort');
  $('#search_filters_wrapper,body').removeClass('showFilter');
  
  $('.close-filter').click(function(){
    $('#search_filters_wrapper').removeClass('showFilter');
    $('.sort-input,body').removeClass('showSort');
  ...
  $('#search_order_toggler').click(function(){
    $('.sort-input').toggleClass('showSort');
    $('#search_filters_wrapper,body').removeClass('showFilter');
    $('body').toggleClass('showSort');
  });

  $('#search_order_toggler').click( function() {
    $(".modalSort").toggleClass("visible-modal");
  });

  $('body').on('click','.search_filter_toggler',function() {
    $(".modalSort").removeClass("visible-modal");
  });
