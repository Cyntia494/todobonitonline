...
class Eter_HomeSlide extends ObjectModel
{
	...
	public static $definition = array(
		...
		'fields' => array(
			...
			'background_mobile' =>			array('type' => self::TYPE_STRING,'validate' => 'isCleanHtml', 'size' => 255),
			'display_mode' =>			array('type' => self::TYPE_STRING, 'size' => 255),
    ...
    public function getAddFieldsValues()
    {
		...
		$fields['background_mobile'] = Tools::getValue('background_mobile');
		$fields['image'] = Tools::getValue('image');
		$fields['display_mode'] =  Tools::getValue('display_mode', $slide->display_mode);
