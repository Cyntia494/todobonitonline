...
class SocialFollowModuleImporter
{
    /**
     * Main method, install social follow info
     */
	public function run() 
    {
        Configuration::updateGlobalValue('BLOCKSOCIAL_FACEBOOK', "#");
        Configuration::updateGlobalValue('BLOCKSOCIAL_TWITTER', "#");
        Configuration::updateGlobalValue('BLOCKSOCIAL_RSS', "");
        Configuration::updateGlobalValue('BLOCKSOCIAL_YOUTUBE', "#");
        Configuration::updateGlobalValue('BLOCKSOCIAL_GOOGLE_PLUS', "");
        Configuration::updateGlobalValue('BLOCKSOCIAL_PINTEREST', "");
        Configuration::updateGlobalValue('BLOCKSOCIAL_VIMEO', "");
        Configuration::updateGlobalValue('BLOCKSOCIAL_INSTAGRAM', "#");
        return ['success' => true];
	}
}