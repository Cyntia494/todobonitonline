	...
	<form method="get" action="{$search_controller_url}">
		...
		<button type="submit" class="no-button">
			<i class="material-icons search">&#xE8B6;</i>
      		<span class="hidden-lg-up">{l s='Search' d='Shop.Theme.Catalog'}</span>
		</button>
		<i class="fas fa-search search-tablet hidden-lg-up"></i>
		<i class="fal fa-times close hidden-lg-up"></i> 
	</form>
</div>
<!-- /Block search module TOP -->
