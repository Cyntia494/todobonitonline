...
{else}
  ...
  <div class="form-group form-section  {$field.name} {if !empty($field.errors)}has-error{/if}">
    <label class="form-label form-control-label{if $field.required} required{/if}">
    ...
    <div class="form-input {if ($field.type === 'radio-buttons')} form-control-valign{/if}">
